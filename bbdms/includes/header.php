...
// Determine the current file running in the browser
                ...
                <div class="col-lg-7 top-social-agile">
                    <div class="row">
                        ...
                        <div class="col-6 header-top_w3layouts pl-3 text-lg-left text-center">
                            <p class="text-white">
                                <i class="fas fa-map-marker-alt mr-2"></i><?php echo htmlentities($result->Address); ?>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-6 top-w3layouts">
                            <p class="text-white">
                                ...
                                <a href="mailto:info@example.com" class="text-white"><?php echo htmlentities($result->EmailId); ?></a>
                            </p>
                        </div>
                        <div class="col-lg-5 col-6 header-w3layouts pl-4 text-lg-left">
                            <p class="text-white">
                                <i class="fas fa-phone mr-2"></i>+<?php echo htmlentities($result->ContactNo); ?>
                            </p>
                        </div>
                    </div>
                    <?php 
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item mt-lg-0 mt-3 <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">
                            <a class="nav-link" href="index.php">Home</a>
                        </li>
                        <li class="nav-item mx-lg-4 my-lg-0 my-3 <?php echo ($current_page == 'about.php') ? 'active' : ''; ?>">
                            <a class="nav-link" href="about.php">About Us</a>
                        </li>
                        <li class="nav-item mx-lg-4 my-lg-0 my-3 <?php echo ($current_page == 'contact.php') ? 'active' : ''; ?>">
                            <a class="nav-link" href="contact.php">Contact Us</a>
                        </li>
                        <li class="nav-item mx-lg-4 my-lg-0 my-3 <?php echo ($current_page == 'donor-list.php') ? 'active' : ''; ?>">
                            <a class="nav-link" href="donor-list.php">Donor List</a>
                        </li>
                        <li class="nav-item mx-lg-4 my-lg-0 my-3 <?php echo ($current_page == 'search-donor.php' || $current_page == 'saerch-donar.php') ? 'active' : ''; ?>">
                        ...
                        <form action="#" method="post" name="signup" onsubmit="return checkpass();">
                            ...
                            <div class="form-group">
                                ...
                                <select name="bloodgroup" class="form-control" required>
                                    ...
                                    ?>  
                                    <option value="<?php echo htmlentities($result_bg->BloodGroup);?>"><?php echo htmlentities($result_bg->BloodGroup);?></option>
                                    <?php 
                                        }
                                    } 
                                    ?>
